...
process REGENIE_STEP1 {
    ...
    python ${params.code_dir}/regenie_step1.py \
        ...
        --pheno_desc ${pheno_desc_rint_file} \
        --output_dir ${params.output_dir}
    """
}
...
workflow {
    ...
    pheno_desc_rint_channel = Channel.value(file(params.pheno_desc_rint_file))
    ...
    regenie_step1_channel = REGENIE_STEP1(snp_qc_channel, pheno_desc_rint_channel)
    regenie_step2_channel = REGENIE_STEP2(regenie_step1_channel, pheno_desc_rint_channel, chromosome_channel)
}
