...
do
    ...
    plink_cmd="plink --bfile \"$input_plink\" --mac 100 --maf 0.01 --hwe 1e-15 --mind 0.1 --geno 0.1 --indep-pairwise 1000 100 0.9 --out ukb22418_c${chr}_b0_v2_filtered"
    # run command with dx
...
do
    # set input files
    input_plink="${user_dir}"/exom_test/ukb22418_c${chr}_b0_v2_filtered
